  ...
  return (
    <>
      ...
      <section className="bg-blue-600 text-white py-12">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <p className="mb-6">
              Book Tata Sumo Gold in Noida Now for
            </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            <img src="/tatasumo.jpg" alt="Tata Sumo Gold" className="w-full h-auto rounded-lg shadow-md" />
          </div>
          <div className="md:w-1/2 md:pl-8">
          ...
          <div className="max-w-7xl mx-auto">
            <Carousel
              images={[
                {
                  src: "/image1.jpg",
                  alt: "Tata Sumo Exterior View"
                },
                {
                  src: "/image2.jpg",
                  alt: "Tata Sumo Interior View"
                },
                {
                  src: "/image3.jpg",
                  alt: "Tata Sumo Side View"
                }
              ]}
            />
          </div>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            <div className="border rounded-lg overflow-hidden">
              ...
              {openFaq === 0 && (
                <div className="p-4 bg-gray-50 border-t">
                  ...
                  Yashika Tour & Travels is in this business since 1995 and is one of the best Tata Sumo Gold booking provider in Noida. Whether it's a business trips or event, employee transportation service, local or outstation tour, etc. we have got a ride for everything! All our Tata Sumo Cabs are GPS enabled so you don't have to worry about security. 
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              {openFaq === 1 && (
                <div className="p-4 bg-gray-50 border-t">
                  <p className="text-gray-600">
                  We are in the tour and travels business for more than 20 years, and we proudly say that we are one of the best Tata Sumo booking service providers in Noida, Greater Noida & Ghaziabad.
                  As of now, we provide Tata Sumo booking in Noida, Greater Noida & Ghaziabad.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="border rounded-lg overflow-hidden">
              <button 
                ...
                onClick={() => toggleFaq(2)}
              >
                <h3 className="text-lg font-semibold text-gray-800">How to book Tata Sumo Gold in Noida?</h3>
                <svg 
              ...
              {openFaq === 2 && (
                <div className="p-4 bg-gray-50 border-t">
                  <p className="text-gray-600">
                  You can easily book Tata Sumo Gold in Noida by filling the form on the homepage of our website, Yashika Tour & Travels or you can call us 24*7 for booking Tata Sumo in Noida for local and outstation travels or for any other purpose. 
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              {openFaq === 3 && (
                <div className="p-4 bg-gray-50 border-t">
                  <p className="text-gray-600">
                  The Tata Sumo Gold is a SUV (Sport Utility Vehicle).
                  </p>
                </div>
              )}
            </div>
