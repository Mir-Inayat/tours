          ...
          <div className="max-w-3xl mx-auto space-y-4">
            <div className="border rounded-lg overflow-hidden">
              <button 
                ...
                onClick={() => toggleFaq(0)}
              >
                <h3 className="text-lg font-semibold text-gray-800">Why choose our Swift Dzire booking service?</h3>
                <svg 
              ...
              {openFaq === 0 && (
                <div className="p-4 bg-gray-50 border-t">
                  ...
                  Yashika Tour & Travels is in this business since 1995 and is one of the best Maruti Suzuki Swift Dzire booking provider in Noida. Whether it's a business trips or event, employee transportation service, local or outstation tour, etc. we have got a ride for everything! All our swift dzire Cabs are GPS enabled so you don't have to worry about security. 
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              {openFaq === 1 && (
                <div className="p-4 bg-gray-50 border-t">
                  <p className="text-gray-600">
                  We are in the tour and travels business for more than 20 years, and we proudly say that we are one of the best Swift Dzire Cab booking service providers in Noida, Greater Noida & Ghaziabad.
                  As of now, we provide Swift Dzire booking in Noida, Greater Noida & Ghaziabad.
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              {openFaq === 2 && (
                <div className="p-4 bg-gray-50 border-t">
                  <p className="text-gray-600">
                  You can easily book Swift Dzire in Noida by filling the form on the homepage of our website, Yashika Tour & Travels or you can call us 24*7 for booking Swift Dzire in Noida for local and outstation travels or for any other purpose. 
                  </p>
                </div>
              )}
            </div>
